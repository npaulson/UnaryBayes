...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        D['param_true'] = np.array([150, .006, 7e-7])
    ...
    cp.plot_cov(flattrace, D['pname_plt'],
    ...
    cp.plot_percent_dev(flattrace, feval_Cp, D,
                        D['param_true'], [1, 1850],
                        xlabel=r"$T \, (K)$")

    cp.plot_percent_dev(flattrace, feval_H, D,
                        D['param_true'], [1, 1850],
                        xlabel=r"$T \, (K)$")
