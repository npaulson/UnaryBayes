...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        D['locV'] = (D['order']+1)*[-2] + [0]
        D['scaleV'] = (D['order']+1)*[4] + [1]
        D['cV'] = (D['order']+2)*[None]
        D['dim'] = len(D['distV'])
        ...
        if D['sampler'] == 'kombine':
            ...
            sys.exit("invalid sampler selected")
    ...
    cp.plot_prediction(flattrace, D['name_list'],
                       ...
                       ylim=(1.1, 2.3), pltname=D['outname'])
